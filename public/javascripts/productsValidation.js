...
//Cambio los estados por defecto de true a false dependiendo si es para crear o editar un producto
...
const validarFormulario = async (e) => {
  const inputsValidations = {
    'producto': () => { validarCampo(expresiones.nombre, e.target, 'producto') },
  }
